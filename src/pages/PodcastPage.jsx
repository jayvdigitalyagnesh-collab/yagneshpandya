...
const PodcastPage = () => {
  ...
  return (
    <div className="podcast-page">
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to right, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.3) 40%, rgba(0,0,0,0.1) 100%)",
            pointerEvents: "none",
          }}
        ></div>
        ...
        >
          ...
          >
            ...
            >
              In my podcast, I speak with founders and leaders about the
              psychology of growth. Listen to real stories of success, failure,
              and the money mindset behind closed doors.
            </p>
      ...
      {/* 2. LATEST EPISODE */}
      <section
        style={{ padding: "var(--section-padding)", backgroundColor: "white" }}
      >
      ...
      <section
        style={{
          ...
          textAlign: "center",
          backgroundImage:
            "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(/p2.png)", // Using p2.png
      ...
      >
        <div className="container" style={{ maxWidth: "700px" }}>
          ...
          >
            As heard on the podcast... Get Yagnesh's Conscious Spending Plan so
            you can spend guilt-free on the things you love:
          </p>
          <div
            style={{
              maxWidth: "550px",
