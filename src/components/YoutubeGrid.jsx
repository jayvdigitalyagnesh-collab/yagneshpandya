...
const API_KEY = 'AIzaSyCgaNYy-xz9V-BBhd6qKAY34h9iwtxY11Y';
const CHANNEL_ID = 'UCvjj3UnvjzxJytHOmR82sDw'; // This is a placeholder Channel ID (Google Developers)
                    ...
                    <div style={{ maxWidth: '600px' }}>
                        ...
                        <Reveal>
                            <h2 style={{
                                ...
                                Talk With Yagnesh <br /> On YouTube
                            </h2>
                        </Reveal>
                    </div>
